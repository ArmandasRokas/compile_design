...
public interface interpreterVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code Floatdec}
	 * labeled alternative in {@link interpreterParser#typeid}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFloatdec(interpreterParser.FloatdecContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFloatConst(interpreterParser.FloatConstContext ctx);
	/**
