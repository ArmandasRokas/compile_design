...
public interface interpreterListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code Floatdec}
	 * labeled alternative in {@link interpreterParser#typeid}.
	 * @param ctx the parse tree
	 */
	void enterFloatdec(interpreterParser.FloatdecContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Floatdec}
	 * labeled alternative in {@link interpreterParser#typeid}.
	 * @param ctx the parse tree
	 */
	void exitFloatdec(interpreterParser.FloatdecContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterFloatConst(interpreterParser.FloatConstContext ctx);
	/**
	 * Exit a parse tree produced by the {@code FloatConst}
	 * labeled alternative in {@link interpreterParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitFloatConst(interpreterParser.FloatConstContext ctx);
	/**
