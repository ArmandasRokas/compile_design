...
public class timeParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public TerminalNode TIME() { return getToken(timeParser.TIME, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof timeVisitor ) return ((timeVisitor<? extends T>)visitor).visitStart(this);
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			{
			setState(2);
			((StartContext)_localctx).t = match(TIME);
			setState(3);
			match(EOF);
			}
		}
